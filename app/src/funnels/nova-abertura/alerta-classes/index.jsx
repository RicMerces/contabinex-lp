...
// Tela 04B — Alerta: Atividade Restrita → Classes Profissionais.
// Modal de redirecionamento sobre a Qualificação esmaecida.
const DESIGN_W = 1920
const DESIGN_H = 1700
const CTA = '#/abrir-empresa/dados-classes'
const BACK = '#/abrir-empresa/qualificacao'

const HEADING = 'Atividade Restrita no MEI'
const BODY =
  'Identificamos que a atividade ou profissão selecionada é regulamentada por conselho de classe e, por lei, não possui permissão para atuar como MEI. Não se preocupe! Para que você possa emitir suas notas fiscais e exercer sua profissão com total tranquilidade, direcionamos o seu perfil de forma automática para o nosso Plano de Classes Profissionais.'
const CTA_LABEL = 'Continuar para Classes Profissionais'
